...
return true; 
    ...
    static void sum_up_recursive(List<Integer> numbers, int target, ArrayList<Integer> partial) {
	    ...
	    public static void main(String args[]) {
	    	...
	    	String[] cards = {"1","10","11","12","6","7","9","10"};
	       ...
	       for (int i = 0; i < cards.length; i++) {
	          ...
	          List<Integer> cardslist = Arrays.stream(numbers).boxed().collect(Collectors.toList());

	     
	       for(int target = 1; target <= 100; target ++) {
	       	
		        sum_up(cardslist,target);
...
//		            System.out.println("sum("+Arrays.toString(solutions.toArray())+")="+target);
	    ...
	    public static ArrayList<SolutionSet> GetSolution(String[] cards) {
